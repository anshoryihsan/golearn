...
func (*GarageCoordinate) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_b97920324bbd1723, []int{0}
}
...
func (*Garage) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_b97920324bbd1723, []int{1}
}
...
func (*GarageList) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_b97920324bbd1723, []int{2}
}
...
func (*GarageListByUser) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_b97920324bbd1723, []int{3}
}
...
func init() { proto.RegisterFile("garage.proto", fileDescriptor_garage_b97920324bbd1723) }

var fileDescriptor_garage_b97920324bbd1723 = []byte{
