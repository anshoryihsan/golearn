...
func (*GarageCoordinate) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_a96b9a5a4e6ec1b0, []int{0}
}
...
func (*Garage) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_a96b9a5a4e6ec1b0, []int{1}
}
...
func (*GarageList) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_a96b9a5a4e6ec1b0, []int{2}
}
...
func (*GarageListByUser) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_a96b9a5a4e6ec1b0, []int{3}
}
...
func (*GarageUserId) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_a96b9a5a4e6ec1b0, []int{4}
}
...
func (*GarageAndUserId) Descriptor() ([]byte, []int) {
	return fileDescriptor_garage_a96b9a5a4e6ec1b0, []int{5}
}
...
func init() { proto.RegisterFile("garage.proto", fileDescriptor_garage_a96b9a5a4e6ec1b0) }

var fileDescriptor_garage_a96b9a5a4e6ec1b0 = []byte{
